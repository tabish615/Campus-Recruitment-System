  ...
  render() {
    return (
      <form>
          ...
          {/* <label className="abc">Email : </label><br />  */}
          <input className="check"type="email" placeholder="Email" required="required" size="50" ref="email" /><br /><br /><br />
          {/* <label>Password : </label><br /> */}
          <input className="check" type="Password" placeholder="Password" required="required" size="50" ref="pass" /><br /><br /><br /><br />
